<template>
  <el-dialog width="700px" :visible="visible" title="导出">
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="onClose">导 出</el-button>
    </span>
  </el-dialog>
</template>

<style lang="scss" scoped src="./index.module.scss">
</style>
  ...
  export default {
    ...
    methods: {
      onExportDSL() {
        ...
        DataUri.downloadBlob(blob, 'sami.dsl.json');
      },
      onExportCode() {
        const zip = new JSZip();
